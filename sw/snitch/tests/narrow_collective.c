...
static inline void cluster_reduction(void * ptr, uint32_t data, uint64_t mask, snrt_reduction_opcode_t operation) {
...
int main (void){
	...
	cluster_reduction(addr_int_add_1, local_contribution, mask, SNRT_REDUCTION_ADD) ;
	...
	cluster_reduction(addr_int_add_2, local_contribution, mask, SNRT_REDUCTION_ADD) ;
	...
	cluster_reduction(addr_int_mul_1, local_contribution, mask, SNRT_REDUCTION_MUL) ;
	...
	cluster_reduction(addr_int_mul_2, local_contribution, mask, SNRT_REDUCTION_MUL) ;
	...
	cluster_reduction(addr_unsigned_max, local_contribution, mask, SNRT_REDUCTION_MAXU) ;
	...
	cluster_reduction(addr_signed_max, local_contribution, mask, SNRT_REDUCTION_MAX) ;
	...
	cluster_reduction(addr_unsigned_min, local_contribution, mask, SNRT_REDUCTION_MINU) ;
	...
	// Determint the local contribution and start the reduction
	local_contribution = - 42 + cluster_id;
	cluster_reduction(addr_signed_min, local_contribution, mask, SNRT_REDUCTION_MIN) ;
